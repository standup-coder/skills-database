...
domain: devops
level: mid
tags: devops, cicd, docker, kubernetes, terraform, cloud
catalogSource: internal
catalogFile: roles/devops-engineer.json
catalogAddedAt: 2026-07-26
experience: 2-5 years
responsibilities: 设计和优化 CI/CD 流水线 | 管理容器和 Kubernetes 集群 | 编写和维护 Terraform / Ansible 基础设施代码 | 多云平台运维与成本优化
mainSkills: docker-container-management, k8s-deployment-review, terraform-plan-review, ci-pipeline-setup, monitoring-stack-setup, incident-diagnosis, security-audit, log-analysis
atomicSkills: read-file, write-file, run-shell-command, docker-exec, validate-k8s-manifest, http-health-check, parse-json-log, api-call, docker-essentials, kubernetes-basics, docker-to-k8s, terraform-basics, ansible-automation, github-actions, gitops-workflow, secrets-management, config-validator, aws-cli-basics, azure-cli-basics, tencent-cloud-lighthouse, cloudflare-manager
---

# DevOps 工程师

> 构建和维护高效的持续交付体系与云原生基础设施

## 职责

- 设计和优化 CI/CD 流水线
- 管理容器和 Kubernetes 集群
- 编写和维护 Terraform / Ansible 基础设施代码
- 多云平台运维与成本优化
...
| 经验 | 2-5 years |
| 学历 | - |
| 核心技术 | Docker, Kubernetes, Terraform, GitHub Actions, AWS/Azure/Tencent Cloud |
